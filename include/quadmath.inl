...
ifdef _LINUX
    name proc syscall uses rbx A:real16, B:real16
else
...
name proc __vectorcall uses rsi rdi rbx q:real16, exponent:int_t
    argq    equ <xmm0>
    qmax    equ <_Q_1E4096>
    temp    equ <xmm0>
    tmp2    equ <xmm2>
...
name proc __cdecl uses esi edi ebx q:ptr, exponent:int_t
...
name proc __vectorcall A:real16, B:real16
...
name proc __vectorcall q:real16
...
name proc __cdecl uses ebx x:ptr, q:ptr
...
name proc uses ebx x:ptr, q:ptr
...
name proc uses esi edi ebx x:ptr, q:ptr
...
name proc __vectorcall l:long_t
...
name proc __vectorcall ll:int64_t
...
name proc uses ebx x:ptr, ll:int64_t
...
name proc __vectorcall h:real2
...
name proc __vectorcall f:real4
...
name proc __vectorcall d:real8
...
name proc __vectorcall ld:real10
...
ifdef _WIN64
    option win64:align
name proc __vectorcall uses rsi rdi rbx q:real16, cvt:ptr, buf:string_t, flags:uint_t
else
name proc __cdecl uses esi edi ebx q:ptr, cvt:ptr, buf:string_t, flags:uint_t
endif
