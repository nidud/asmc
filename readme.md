...
Asmc is a slow-burning attempt of make a functional programming language out of assembly. It supports AVX-512 instructions (Masm v14) but the [Version](doc/symbol/at-version.md) macro is currently set to v10.
