...
bitsize64 proc fastcall h, l ; qword
;
...
;
    ...
    mov ecx,[ecx+8]
    mov [esi],eax
    mov [esi].ELD.m32[1*4],edx
    mov [esi].ELD.m32[2*4],ecx
...
;
    mov esi,res
    add bitsize64([esi].u192.m32[2*8], [esi].u192.m32[2*8+4]),128
    mov edi,eax

    .if eax == 128
        m2m64 [esi].u192.m64[2*8],[esi].u192.m64[1*8]
        m2m64 [esi].u192.m64[1*8],[esi].u192.m64[0*8]
        mov [esi].u192.m32[0],0
        mov [esi].u192.m32[4],0
        add bitsize64([esi].u192.m32[2*8], [esi].u192.m32[2*8+4]),64
        mov edi,eax
    .endif
    ...
    .if edi == 64
        ...
        mov [esi].u192.m32[0],0
        mov [esi].u192.m32[4],0
        mov edi,bitsize64([esi].u192.m32[2*8], [esi].u192.m32[2*8+4])
    .endif
    mov eax,edi
    .if eax
        ...
        .if eax
            ...
            mov eax,[esi].u192.m32[2*8]
            mov edx,[esi].u192.m32[2*8][4]
            call _I8LS
            mov [esi].u192.m32[2*8],eax
            mov [esi].u192.m32[2*8][4],edx

            mov eax,[esi].u192.m32[1*8]
            mov edx,[esi].u192.m32[1*8][4]
            call llshr
            or [esi].u192.m32[2*8],eax
            or [esi].u192.m32[2*8][4],edx

            mov eax,[esi].u192.m32[1*8]
            mov edx,[esi].u192.m32[1*8][4]
            call _I8LS
            mov [esi].u192.m32[1*8],eax
            mov [esi].u192.m32[1*8][4],edx

            mov eax,[esi].u192.m32[0*8]
            mov edx,[esi].u192.m32[0*8][4]
            call llshr
            or [esi].u192.m32[1*8],eax
            or [esi].u192.m32[1*8][4],edx

            mov eax,[esi].u192.m32[0*8]
            mov edx,[esi].u192.m32[0*8][4]
            call _I8LS
            mov [esi].u192.m32[0*8],eax
            mov [esi].u192.m32[0*8][4],edx
        .endif
        pop eax
        sub eax,192
    .endif
...
add192 proc uses esi res:ptr, x:qword, pos:SINT
;
...
;
    ...
    .for ecx = pos: ecx < 6: ecx++
        add eax,[esi].u192.m32[ecx*4]
        adc edx,0
        mov [esi].u192.m32[ecx*4],eax
        mov eax,edx
        xor edx,edx
    .endf
