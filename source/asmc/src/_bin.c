...
static void __fastcall CalcOffset( struct dsym *curr, struct calc_param *cp )
/****************************************************************/
{
    uint_32 align;
    uint_32 alignbytes;
...
static int __fastcall GetSegRelocs( uint_16 *pDst )
/**************************************/
{
    struct dsym *curr;
    int count = 0;
...
static uint_32 __fastcall GetImageSize( bool memimage )
/******************************************/
{
    struct dsym *curr;
    bool first;
...
static int __fastcall DoFixup( struct dsym *curr, struct calc_param *cp )
/*****************************************************************/
{
...
static void __fastcall pe_create_MZ_header( struct module_info *modinfo )
/************************************************************/
{
    const char *p;
    struct asym *sym;
...
static void __fastcall set_file_flags( struct asym *sym, struct expr *opnd )
/***************************************************************/
{
    struct dsym *pehdr;
...
#ifdef __DZC__
static int __stdcall compare_exp( const void *p1, const void *p2 )
#else
...
static int __fastcall get_bit( int value )
/*****************************/
{
    int rc = -1;
    while( value ) {
...
static uint_32 __fastcall pe_get_characteristics( struct dsym *seg )
/*******************************************************/
{
    uint_32 result = 0;
...
static void __fastcall pe_set_base_relocs( struct dsym *reloc )
/**************************************************/
{
    int cnt1 = 0;
    int cnt2 = 0;
...
static void __fastcall pe_set_values( struct calc_param *cp )
/************************************************/
{
    int i;
    int falign;
	...
	if ( reloc ) {
	    ...
	    memzero( objtab->e.seginfo->CodeBuffer + objtab->sym.max_offset, sizeof( struct IMAGE_SECTION_HEADER ) );
