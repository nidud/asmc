...
static int __fastcall FindToken( const char *token, const char * const *table, int size )
/****************************************************************************/
{
    int i;
...
static struct asym * __fastcall AddPredefinedConstant( const char *name, int value )
/**********************************************************************/
{
...
static int __fastcall SetDefaultOfssize( int size )
/*******************************************/
{
