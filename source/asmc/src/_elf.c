...
/*********************************************************************************************/
{
    ...
    em->internal_segs[SYMTAB_IDX].data = (int *)LclAlloc( em->internal_segs[SYMTAB_IDX].size );
    memzero( em->internal_segs[SYMTAB_IDX].data, em->internal_segs[SYMTAB_IDX].size );
...
/************************************************/
{
    ...
    em->internal_segs[STRTAB_IDX].data = (int *)LclAlloc( strsize );
    memzero( em->internal_segs[STRTAB_IDX].data, strsize );
...
/**************************************************/
{
    ...
    em->internal_segs[SHSTRTAB_IDX].data = (int *)LclAlloc( size );
...
/****************************************************************/
{
	...
	default:
		...
		asmerr( 3014, fixup->type, curr->sym.name, fixup->locofs );
	}
