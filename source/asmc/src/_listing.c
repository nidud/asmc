...
void __stdcall LstWrite( enum lsttype type, uint_32 oldofs, void *value )
/*************************************************************/
{
    uint_32 newofs;
...
void __cdecl LstPrintf( const char *format, ... )
/***************************************/
{
    va_list	args;
...
#ifdef __DZC__
static int __stdcall compare_syms( const void *p1, const void *p2 )
#else
