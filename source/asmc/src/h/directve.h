...
res(DOT_ELSEIFD,    .elseifd,	 DF_CGEN|DF_CEXPR, DRT_HLLEXIT, 0, P_64, 0)
res(DOT_ELSEIFSD,   .elseifsd,	 DF_CGEN|DF_CEXPR, DRT_HLLEXIT, 0, P_64, 0)
...
res(DOT_ASSERT,	    .assert,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_ASSERT, 0, P_86, 0)
res(DOT_ASSERTB,    .assertb,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_ASSERT, 0, P_86, 0)
res(DOT_ASSERTW,    .assertw,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_ASSERT, 0, P_86, 0)
res(DOT_ASSERTD,    .assertd,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_ASSERT, 0, P_86, 0)

res(DOT_FOR,	    .for,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_HLLFOR, 0, P_86, 0)
res(DOT_FORS,	    .fors,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_HLLFOR, 0, P_86, 0)
res(DOT_ENDF,	    .endf,	 DF_CGEN,					DRT_HLLFOR, 0, P_86, 0)

res(UNDEF,	    undef,	 DF_NOEXPAND|DF_NOCONCAT,			DRT_UNDEF,  0, P_86, 0)
res(DOT_CLASS,	    .class,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_CLASS,  0, P_86, 0)
res(DOT_COMDEF,	    .comdef,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_CLASS,  0, P_86, 0)
res(DOT_TEMPLATE,   .template,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_CLASS,  0, P_86, 0)
...
res(DOT_NEW,	    .new,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_NEW,    0, P_86, 0)
res(DOT_ENUM,	    .enum,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC|DF_NOCONCAT, DRT_ENUM,   0, P_86, 0)
res(DOT_ENUMT,	    .enumt,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC|DF_NOCONCAT, DRT_ENUM,   0, P_86, 0)
