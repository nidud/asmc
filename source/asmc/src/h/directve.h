...
res(DOT_CLASS,	    .class,	 DF_LABEL,					DRT_CLASS,  0, P_86, 0)
res(DOT_COMDEF,	    .comdef,	 DF_LABEL,					DRT_CLASS,  0, P_86, 0)
res(DOT_TEMPLATE,   .template,	 DF_LABEL,					DRT_CLASS,  0, P_86, 0)
res(DOT_OPERATOR,   .operator,	 DF_LABEL,					DRT_CLASS,  0, P_86, 0)
res(DOT_STATIC,	    .static,	 DF_LABEL,					DRT_CLASS,  0, P_86, 0)
res(DOT_ENDS,	    .ends,	 DF_LABEL,					DRT_CLASS,  0, P_86, 0)
