...
res(DOT_CLASSDEF,   .classdef,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_CLASSDEF, 0, P_86, 0)
res(DOT_COMDEF,	    .comdef,	 DF_CGEN|DF_CEXPR|DF_NOSTRUC|DF_STORE|DF_PROC,	DRT_CLASSDEF, 0, P_86, 0)
res(DOT_ENDS,	    .ends,	 DF_CGEN,					DRT_CLASSDEF, 0, P_86, 0)
...
res(DOT_GOTOSW1,    .gotosw1,	 DF_CGEN,					DRT_SWITCH, 0, P_86, 0)
res(DOT_GOTOSW2,    .gotosw2,	 DF_CGEN,					DRT_SWITCH, 0, P_86, 0)
res(DOT_GOTOSW3,    .gotosw3,	 DF_CGEN,					DRT_SWITCH, 0, P_86, 0)
