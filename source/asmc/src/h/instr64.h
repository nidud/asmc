...
ins (CALL, call,  OpCls( I32,	  NONE,	  NONE ), 0,	   0,  no_RM,  0xE8, 0x00, P_64,  0,0)
...
ins (JMP, jmp,	  OpCls( I8,	NONE,	  NONE ), 0,	   0,  no_RM,  0xEB, 0x00, P_86,  0,0)
...
ins (LGDT, lgdt,  OpCls( M80,	NONE,	  NONE ), F_0F,	   0,  no_WDS, 0x01, 0x10, P_64,  0,0)
ins (LIDT, lidt,  OpCls( M80,	NONE,	  NONE ), F_0F,	   0,  no_WDS, 0x01, 0x18, P_64,  0,0)

ins (SLDT, sldt,  OpCls( RGT8,	NONE,	  NONE ), F_0F,	   0,  no_WDS, 0x00, 0x00, P_64,  0,0)
insn(SLDT, 1,	  OpCls( M16,	NONE,	  NONE ), F_0FNO66,0,  no_WDS, 0x00, 0x00, P_286, 0,0)
ins (SMSW, smsw,  OpCls( RGT8,	NONE,	  NONE ), F_0F,	   0,  no_WDS, 0x01, 0x20, P_64,  0,0)
insn(SMSW, 1,	  OpCls( M16,	NONE,	  NONE ), F_0FNO66,0,  no_WDS, 0x01, 0x20, P_286, 0,0)
ins (STR,  str,	  OpCls( RGT8,	NONE,	  NONE ), F_0F,	   0,  no_WDS, 0x00, 0x08, P_64,  0,0)
insn(STR,  1,	  OpCls( M16,	NONE,	  NONE ), F_0FNO66,0,  no_WDS, 0x00, 0x08, P_286, 0,0)

/* v2.06: POP/PUSH added */
ins (POP, pop,	  OpCls( R16_R64, NONE,	  NONE ), 0,	   0,  R_in_OP,0x58, 0x00, P_86,  0,0)
...
ins (PUSH, push,  OpCls( R16_R64, NONE,	  NONE ), 0,	   0,  R_in_OP,0x50, 0x00, P_86,  0,0)
...
ins (VMREAD,  vmread,  OpCls( R64_M64, R64, NONE ), F_0F,  0,  no_WDS, 0x78, 0x00, P_686p,0,0)
ins (VMWRITE, vmwrite, OpCls( R64, R64_M64, NONE ), F_0F,  1,  no_WDS, 0x79, 0x00, P_686p,0,0)
