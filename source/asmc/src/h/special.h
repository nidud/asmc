...
res(XMM0, xmm0, RWT_REG,    OP_XMM,	0,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM1, xmm1, RWT_REG,    OP_XMM,	1,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM2, xmm2, RWT_REG,    OP_XMM,	2,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM3, xmm3, RWT_REG,    OP_XMM,	3,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM4, xmm4, RWT_REG,    OP_XMM,	4,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM5, xmm5, RWT_REG,    OP_XMM,	5,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM6, xmm6, RWT_REG,    OP_XMM,	6,	 0,   P_SSE1,  SFR_IREG|16)
res(XMM7, xmm7, RWT_REG,    OP_XMM,	7,	 0,   P_SSE1,  SFR_IREG|16)

res(YMM0, ymm0, RWT_REG,    OP_YMM,	0,	 0,   P_AVX,   SFR_IREG|32)
res(YMM1, ymm1, RWT_REG,    OP_YMM,	1,	 0,   P_AVX,   SFR_IREG|32)
res(YMM2, ymm2, RWT_REG,    OP_YMM,	2,	 0,   P_AVX,   SFR_IREG|32)
res(YMM3, ymm3, RWT_REG,    OP_YMM,	3,	 0,   P_AVX,   SFR_IREG|32)
res(YMM4, ymm4, RWT_REG,    OP_YMM,	4,	 0,   P_AVX,   SFR_IREG|32)
res(YMM5, ymm5, RWT_REG,    OP_YMM,	5,	 0,   P_AVX,   SFR_IREG|32)
res(YMM6, ymm6, RWT_REG,    OP_YMM,	6,	 0,   P_AVX,   SFR_IREG|32)
res(YMM7, ymm7, RWT_REG,    OP_YMM,	7,	 0,   P_AVX,   SFR_IREG|32)
...
res(ZMM0, zmm0, RWT_REG,    OP_ZMM,	0,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM1, zmm1, RWT_REG,    OP_ZMM,	1,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM2, zmm2, RWT_REG,    OP_ZMM,	2,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM3, zmm3, RWT_REG,    OP_ZMM,	3,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM4, zmm4, RWT_REG,    OP_ZMM,	4,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM5, zmm5, RWT_REG,    OP_ZMM,	5,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM6, zmm6, RWT_REG,    OP_ZMM,	6,	 0,   P_AVX,   SFR_IREG|64)
res(ZMM7, zmm7, RWT_REG,    OP_ZMM,	7,	 0,   P_AVX,   SFR_IREG|64)
...
res(RIP,  rip,	RWT_REG,    OP_RIP,    16, RWF_X64,    P_64,   SFR_IREG|8)

res(XMM8, xmm8, RWT_REG,    OP_XMM,	8, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM9, xmm9, RWT_REG,    OP_XMM,	9, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM10,xmm10,RWT_REG,    OP_XMM,    10, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM11,xmm11,RWT_REG,    OP_XMM,    11, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM12,xmm12,RWT_REG,    OP_XMM,    12, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM13,xmm13,RWT_REG,    OP_XMM,    13, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM14,xmm14,RWT_REG,    OP_XMM,    14, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM15,xmm15,RWT_REG,    OP_XMM,    15, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM16,xmm16,RWT_REG,    OP_XMM,    16, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM17,xmm17,RWT_REG,    OP_XMM,    17, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM18,xmm18,RWT_REG,    OP_XMM,    18, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM19,xmm19,RWT_REG,    OP_XMM,    19, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM20,xmm20,RWT_REG,    OP_XMM,    20, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM21,xmm21,RWT_REG,    OP_XMM,    21, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM22,xmm22,RWT_REG,    OP_XMM,    22, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM23,xmm23,RWT_REG,    OP_XMM,    23, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM24,xmm24,RWT_REG,    OP_XMM,    24, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM25,xmm25,RWT_REG,    OP_XMM,    25, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM26,xmm26,RWT_REG,    OP_XMM,    26, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM27,xmm27,RWT_REG,    OP_XMM,    27, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM28,xmm28,RWT_REG,    OP_XMM,    28, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM29,xmm29,RWT_REG,    OP_XMM,    29, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM30,xmm30,RWT_REG,    OP_XMM,    30, RWF_X64,    P_64,   SFR_IREG|16)
res(XMM31,xmm31,RWT_REG,    OP_XMM,    31, RWF_X64,    P_64,   SFR_IREG|16)

res(YMM8, ymm8, RWT_REG,    OP_YMM,	8, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM9, ymm9, RWT_REG,    OP_YMM,	9, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM10,ymm10,RWT_REG,    OP_YMM,    10, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM11,ymm11,RWT_REG,    OP_YMM,    11, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM12,ymm12,RWT_REG,    OP_YMM,    12, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM13,ymm13,RWT_REG,    OP_YMM,    13, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM14,ymm14,RWT_REG,    OP_YMM,    14, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM15,ymm15,RWT_REG,    OP_YMM,    15, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM16,ymm16,RWT_REG,    OP_YMM,    16, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM17,ymm17,RWT_REG,    OP_YMM,    17, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM18,ymm18,RWT_REG,    OP_YMM,    18, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM19,ymm19,RWT_REG,    OP_YMM,    19, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM20,ymm20,RWT_REG,    OP_YMM,    20, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM21,ymm21,RWT_REG,    OP_YMM,    21, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM22,ymm22,RWT_REG,    OP_YMM,    22, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM23,ymm23,RWT_REG,    OP_YMM,    23, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM24,ymm24,RWT_REG,    OP_YMM,    24, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM25,ymm25,RWT_REG,    OP_YMM,    25, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM26,ymm26,RWT_REG,    OP_YMM,    26, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM27,ymm27,RWT_REG,    OP_YMM,    27, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM28,ymm28,RWT_REG,    OP_YMM,    28, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM29,ymm29,RWT_REG,    OP_YMM,    29, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM30,ymm30,RWT_REG,    OP_YMM,    30, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)
res(YMM31,ymm31,RWT_REG,    OP_YMM,    31, RWF_X64,    P_AVX|P_64,  SFR_IREG|32)

res(ZMM8, zmm8, RWT_REG,    OP_ZMM,	8, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM9, zmm9, RWT_REG,    OP_ZMM,	9, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM10,zmm10,RWT_REG,    OP_ZMM,    10, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM11,zmm11,RWT_REG,    OP_ZMM,    11, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM12,zmm12,RWT_REG,    OP_ZMM,    12, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM13,zmm13,RWT_REG,    OP_ZMM,    13, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM14,zmm14,RWT_REG,    OP_ZMM,    14, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM15,zmm15,RWT_REG,    OP_ZMM,    15, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM16,zmm16,RWT_REG,    OP_ZMM,    16, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM17,zmm17,RWT_REG,    OP_ZMM,    17, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM18,zmm18,RWT_REG,    OP_ZMM,    18, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM19,zmm19,RWT_REG,    OP_ZMM,    19, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM20,zmm20,RWT_REG,    OP_ZMM,    20, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM21,zmm21,RWT_REG,    OP_ZMM,    21, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM22,zmm22,RWT_REG,    OP_ZMM,    22, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM23,zmm23,RWT_REG,    OP_ZMM,    23, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM24,zmm24,RWT_REG,    OP_ZMM,    24, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM25,zmm25,RWT_REG,    OP_ZMM,    25, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM26,zmm26,RWT_REG,    OP_ZMM,    26, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM27,zmm27,RWT_REG,    OP_ZMM,    27, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM28,zmm28,RWT_REG,    OP_ZMM,    28, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM29,zmm29,RWT_REG,    OP_ZMM,    29, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM30,zmm30,RWT_REG,    OP_ZMM,    30, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
res(ZMM31,zmm31,RWT_REG,    OP_ZMM,    31, RWF_X64,    P_AVX|P_64,  SFR_IREG|64)
...
res(REAL2,  real2,   RWT_STYPE,	 0,	    MT_REAL2,	0, P_86,    USE_EMPTY)
...
res(YWORD,  yword,   RWT_STYPE,	 0,	    MT_YMMWORD, 0, P_AVX,   USE_EMPTY)
res(ZWORD,  zword,   RWT_STYPE,	 0,	    MT_ZMMWORD, 0, P_AVX,   USE_EMPTY)
...
res(DOT_HIGH,	.high,	      RWT_UNARY_OP, AT_TLN,	6,  0,	 P_86,	UOT_DOT_HIGH )
...
res(DOT_LENGTH, .length,      RWT_UNARY_OP, AT_LF,	3,  0,	 P_86,	UOT_DOT_LENGTH )
res(LENGTHOF,	lengthof,     RWT_UNARY_OP, AT_LF,	3,  0,	 P_86,	UOT_LENGTHOF  )
res(DOT_LOW,	.low,	      RWT_UNARY_OP, AT_TLN,	6,  0,	 P_86,	UOT_DOT_LOW   )
...
res(DOT_MASK,	.mask,	      RWT_UNARY_OP, AT_TBF,	3,  0,	 P_86,	UOT_DOT_MASK  )
...
res(DOT_SIZE,	.size,	      RWT_UNARY_OP, AT_TLF,	3,  0,	 P_86,	UOT_DOT_SIZE  )
res(SIZEOF,	sizeof,	      RWT_UNARY_OP, AT_TLF,	3,  0,	 P_86,	UOT_SIZEOF    )
res(DOT_THIS,	.this,	      RWT_UNARY_OP, AT_TYPE,	5,  0,	 P_86,	UOT_DOT_THIS  )
res(TYPEOF,	typeof,	      RWT_UNARY_OP, AT_ALL,	5,  0,	 P_86,	UOT_TYPEOF    )
res(DOT_WIDTH,	.width,	      RWT_UNARY_OP, AT_TBF,	3,  0,	 P_86,	UOT_DOT_WIDTH )
res(HIGH64,	high64,	      RWT_UNARY_OP, AT_CONST | AT_FLOAT, 6,  0, P_64, UOT_HIGH64 )
res(LOW64,	low64,	      RWT_UNARY_OP, AT_TLN | AT_FLOAT,	6,  0, P_64, UOT_LOW64 )
...
res(CCALL,	ccall,	      RWT_RES_ID, 0, LANG_C,	      0, P_86, 0)
