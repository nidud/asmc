...
static char cp_options[] =
 ...
 "/elf64 Generate 64-bit ELF object file     /swc C .SWITCH (default)\n"
 "/EP Output preprocessed listing to stdout  /swn No table in .SWITCH\n"
 "/eq Don't display error messages           /swp Pascal .SWITCH (auto .break)\n"
 "/Fd[file] Write import definition file     /swr Switch uses R10/R11 (default)\n"
 "/Fi<file> Force <file> to be included      /swt Use table in .SWITCH (default)\n"
 "/Fl[file] Generate listing                 /Sx List false conditionals\n"
 "/Fo<file> Name object file                 /w Same as /W0 /WX\n"
 ...
 "/q, /nologo Suppress copyright message\n";
#else
