...
inl proto asmcall :float,:float,:byte,:float,:float,:word,:double,:double,:double,:dword,:qword,
...
stk proto asmcall :byte, :word, :dword, :qword, :ptr, :ptr, :ptr, :ptr {
    add rax,_8      ; [rsp]
    }

i16 proto asmcall :oword, :oword, :oword, :ptr {
