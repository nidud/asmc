...
E1  dq E(INTER),E(INTER),E(INTER),E(INTER),E(A2004),E(A2005),E(A2006),E(A2007),E(A2008),E(A2009),
       ...
       E(INTER),E(A2151),E(INTER),E(INTER),E(A2154),E(INTER),E(A2156),E(A2157),E(INTER),E(A2159),
...
MAX_E1 equ ($ - E1) / 8
E2  dq E(A3000),E(A3001),E(A3002),E(A3003),E(A3004),E(A3005),E(A3006),E(A3007),E(A3008),E(A3009),
       E(A3010),E(A3011),E(A3012),E(A3013),E(A3014),E(A3015),E(A3016),E(A3017),E(A3018),E(A3019),
       E(A3020),E(A3021),E(A3022)
W1  dq E(INTER),E(INTER),E(INTER),E(A4003),E(INTER),E(A4005),E(A4006),E(A4007),E(A4008),E(INTER),
       E(INTER),E(A4011),E(A4012),E(INTER),E(A4910)
W2  dq E(INTER)
W3  dq E(INTER),E(INTER),E(INTER),E(A6003),E(A6004),E(A6005)
W4  dq E(A7000),E(A7001),E(A7002),E(A7003),E(A7004),E(A7005),E(A7006),E(A7007),E(A7008)
W5  dq E(A8000),E(A8001),E(A8002),E(A8003),E(A8004),E(A8005),E(A8006),E(A8007),E(A8008),E(A8009),
       E(A8010),E(A8011),E(A8012),E(A8013),E(A8014),E(A8015),E(INTER),E(A8017),E(A8018),E(A8019),
       E(A8020)

MS  dq E("name"),E("page"),E("subtitle"),E("subttl"),E("title"),E("low"),E("high"),E("size"),
       E("length"),E("this"),E("mask"),E("width"),E("type"),0

MAX_E0 equ lengthof(E0)
MAX_E2 equ lengthof(E2)
MAX_W1 equ lengthof(W1)
MAX_W2 equ lengthof(W2)
MAX_W3 equ lengthof(W3)
MAX_W4 equ lengthof(W4)
MAX_W5 equ lengthof(W5)

table   dq E0,E1,E2,W1,W2,W3,W4,W5
...
NOTE    dq N0000,N0001,N0002,N0003
...
errexit proc __ccall private
    ...
    .if ModuleInfo.curr_fname[ASM*8]
...
WriteError proc __ccall
    ...
    .return( asmerr( 1002, ModuleInfo.curr_fname[OBJ*8] ) )
...
PrintNote proc __ccall value:int_t, args:vararg
  ...
  local erbuf[512]:byte
    ...
    lea rax,NOTE
   .return( print_err( &erbuf, [rax+rcx*8], &args ) )
