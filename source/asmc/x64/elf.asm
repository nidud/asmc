...
elf_write_section_table64 proc __ccall private uses rbx r12 r13 modinfo:ptr module_info, em:ptr elfmod, fileoffset:uint_t
   ...
   .new shdr64:Elf64_Shdr
    ...
    .for ( r12d = 0: r12d < NUM_INTSEGS: r12d++ )
        ...
        .endif
        .ifd ( fwrite( &shdr64, 1, sizeof( shdr64 ), CurrFile[OBJ*8] ) != sizeof( shdr64 ) )
            WriteError()
        .endif
...
ifndef ASMC64
    ...
    .case USE64
        ...
        .if ( fwrite( &em.ehdr64, 1, sizeof( em.ehdr64 ), CurrFile[OBJ*8] ) != sizeof( em.ehdr64 ) )
            WriteError()
        .endif
...
ifndef ASMC64
    ...
    .default
        ...
        .if ( fwrite( &em.ehdr32, 1, sizeof( em.ehdr32 ), CurrFile[OBJ*8] ) != sizeof( em.ehdr32 ) )
            WriteError()
        .endif
