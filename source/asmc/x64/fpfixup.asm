...
AddFloatingPointEmulationFixup proc uses rsi rdi rbx CodeInfo:ptr code_info
  ...
  local name[2]:DWORD
    ...
    .for ( ebx = 0 : ebx < 2 : ebx++ )
        ...
        .if ( eax & patchmask )
            ...
            mov sym[rbx*8],SymSearch( &name )

            .if ( rax == NULL || [rax].asym.state == SYM_UNDEFINED )
                mov sym[rbx*8],MakeExtern( &name, MT_FAR, NULL, rax, USE16 )
