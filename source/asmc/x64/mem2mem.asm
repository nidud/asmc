...
InlineCopy proc __ccall private dst:ptr, src:ptr, count:uint_t
    ...
    AddLineQueueX(
        ...
        " pop %r\n"
        " pop %r\n"
        " pop %r", eax, r10d, r11d, eax, rdx, r10d, rcx, r8d, r11d, r10d, eax )
    ret
...
SizeFromExpression proc __ccall private opnd:ptr expr
