...
putFrameDatum proc __ccall private p:ptr byte, method:byte, datum:word

    .switch( dl )
    .case FRAME_SEG
    .case FRAME_GRP
    .case FRAME_EXT
        .return( putIndex( rcx, r8w ) )
...
putTargetDatum proc __ccall private p:ptr byte, method:byte, datum:word
