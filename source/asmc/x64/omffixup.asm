...
TranslateLogref proc private uses rsi rdi rbx lr:ptr logref, buf:ptr byte, type:fixgen_types
...
OmfFixGenFixModend proc uses rdi rbx fixp:ptr fixup, buf:ptr byte, displ:dword, type:fixgen_types
...
omf_fill_logref proc private uses rsi rdi rbx fixp:ptr fixup, lr:ptr logref
...
OmfFixGenFix proc uses rsi rdi rbx fixp:ptr fixup, start_loc:dword, buf:ptr byte, type:fixgen_types
...
ifndef ASMC64
    ...
    .default ;; shouldn't happen. Check for valid fixup has already happened
        ...
        lea rax,szNull
        .if ( rdi )
            mov rax,[rdi].asym.name
        .endif
        asmerr( 3001, [rcx].format_options.formatname, eax )
        .return( 0 )
    .endsw
    mov al,0xc0
    .if ( self_relative )
