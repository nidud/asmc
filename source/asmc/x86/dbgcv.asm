...
getregister proc fastcall uses esi edi ebx sym:ptr asym
    ...
    .else
        ...
        .else
            ...
            .if ( ( ModuleInfo.cv_opt & CVO_STATICTLS ) && [ecx].seg_info.clsym )
                ...
                .if ( tstrcmp( [ecx].asym.name, "TLS" ) == 0 )
...
MD5Update proc private uses esi edi ebx ctx:ptr MD5_CTX, buf:ptr byte, len:dword
...
ifdef USEMD5
       ...
       .endif
        ...
        .if ( tmemicmp( esi, cv.currdir, ebx ) == 0 )
            lea esi,[esi+ebx+1]
        .endif
        inc strlen( esi )
        mov ecx,eax
