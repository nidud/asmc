...
asin proc x:double
  ...
  local polynomial:double, d0:double, d1:double
    ...
    .else
        ...
        .if _mm_comile_sd(xmm0, FLT8(0.5))
            ...
            .if _mm_comige_sd(xmm0, FLT8(1.0))
                ...
                .if _mm_comige_sd(xmm0, FLT8(-2.1491193328908206e-8))

                    _mm_move_sd(xmm1, FLT8(2.1491193328908206e-8))
                    .if _mm_comige_sd(xmm1, xmm0)

                        .return .if _mm_comile_sd(xmm0, FLT8(-2.2250738585072014e-308))

                        _mm_move_sd(xmm1, FLT8(2.2250738585072014e-308))
    ...
    .if _mm_comige_sd(xmm0, xmm1)
        ...
        _mm_move_sd(xmm0, FLT8(1.5707963267948966)) ; Pi/2 rounded down
        .return
    ...
    _mm_move_sd(xmm2, FLT8(134217729.0))
    ...
    _mm_move_sd(xmm4, FLT8(134217729.0))
    ...
    _mm_move_pd(xmm4, xmm0)
    _mm_move_sd(xmm0, FLT8(-1.5707961988153776))
    _mm_move_sd(xmm1, FLT8(1.0640719477080884e-16))
    ...
    _mm_move_sd(xmm6, FLT8(134217729.0))
    _mm_move_pd(xmm5, xmm0)
    ...
    _mm_move_sd(xmm2, FLT8(1.5707963267948966))
    _mm_move_sd(xmm3, FLT8(6.123233995736766e-17))
