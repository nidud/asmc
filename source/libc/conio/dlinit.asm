...
dlinit proc uses rsi rdi rbx td:PDOBJ
  ...
  local object:PTOBJ, wp:PCHAR_INFO, window:ptr
    ...
    .if ( edi & W_VISIBLE )
        ...
        mov wp,[rbx].DOBJ.wp
        .if ( _rcalloc([rbx].DOBJ.rc, W_UTF16) == NULL )
    ...
    .if ( flags & W_VISIBLE )
        ...
        mov rbx,td
        _rcwrite([rbx].DOBJ.rc, [rbx].DOBJ.wp)
        free([rbx].DOBJ.wp)
        mov [rbx].DOBJ.wp,wp
    .endif
    ret
