...
__crtIsPackagedApp proc WINAPI
...
__crtSetUnhandledExceptionFilter proc WINAPI exceptionFilter:LPTOP_LEVEL_EXCEPTION_FILTER
...
__crtTerminateProcess proc WINAPI uExitCode:UINT
...
__crtUnhandledException proc WINAPI exceptionInfo:ptr EXCEPTION_POINTERS
...
__crtCapturePreviousContext proc WINAPI pContextRecord:ptr CONTEXT
...
__crtGetTickCount64 proc WINAPI
...
__crtFlsAlloc proc WINAPI lpCallback:PFLS_CALLBACK_FUNCTION
...
__crtFlsFree proc WINAPI dwFlsIndex:DWORD
if _CRT_NTDDI_MIN GE NTDDI_WS03
    FlsFree(dwFlsIndex)
else
...
__crtFlsGetValue proc WINAPI dwFlsIndex:DWORD
if _CRT_NTDDI_MIN GE NTDDI_WS03
...
__crtFlsSetValue proc WINAPI dwFlsIndex:DWORD, lpFlsData:PVOID
...
__crtInitializeCriticalSectionEx proc WINAPI lpCriticalSection:LPCRITICAL_SECTION,
...
__crtCreateEventExW proc WINAPI lpEventAttributes:LPSECURITY_ATTRIBUTES,
    ...
    and ecx,CREATE_EVENT_INITIAL_SET
    .return CreateEventW( lpEventAttributes, edx, ecx, lpName )

__crtCreateEventExW endp


__crtCreateSemaphoreExW proc WINAPI lpSemaphoreAttributes:LPSECURITY_ATTRIBUTES, lInitialCount:LONG,
...
__crtSetThreadStackGuarantee proc WINAPI StackSizeInBytes:PULONG
...
__crtSetThreadpoolTimer proc WINAPI pti:PTP_TIMER, pftDueTime:PFILETIME, msPeriod:DWORD, msWindowLength:DWORD
...
__crtWaitForThreadpoolTimerCallbacks proc WINAPI pti:PTP_TIMER, fCancelPendingCallbacks:BOOL
...
__crtCloseThreadpoolTimer proc WINAPI pti:PTP_TIMER
...
__crtSetThreadpoolWait proc WINAPI pwa:PTP_WAIT, h:HANDLE, pftTimeout:PFILETIME
...
__crtCloseThreadpoolWait proc WINAPI pwa:PTP_WAIT
...
__crtFlushProcessWriteBuffers proc WINAPI
...
__crtFreeLibraryWhenCallbackReturns proc WINAPI pci:PTP_CALLBACK_INSTANCE, _mod:HMODULE
...
__crtGetCurrentProcessorNumber proc WINAPI
...
__crtGetLogicalProcessorInformation proc WINAPI Buffer:PSYSTEM_LOGICAL_PROCESSOR_INFORMATION, ReturnLength:PDWORD
...
__crtCreateSymbolicLinkW proc WINAPI lpSymlinkFileName:LPCWSTR, lpTargetFileName:LPCWSTR, dwFlags:DWORD
...
__crtGetFileInformationByHandleEx proc WINAPI hFile:HANDLE, FileInformationClass:FILE_INFO_BY_HANDLE_CLASS,
...
__crtSetFileInformationByHandle proc WINAPI hFile:HANDLE, FileInformationClass:FILE_INFO_BY_HANDLE_CLASS,
        lpFileInformation:LPVOID, dwBufferSize:DWORD
...
__crtSleep proc WINAPI dwMilliseconds:DWORD
...
__crtLoadWinApiPointers proc WINAPI uses rbx
