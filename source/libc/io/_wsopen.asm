...
ifdef __UNIX__
_wsopen proc path:wstring_t, oflag:int_t, shflag:int_t, args:vararg
    _set_errno( ENOSYS )
else
_wsopen proc uses rsi rdi rbx path:wstring_t, oflag:int_t, shflag:int_t, args:vararg
    ...
    .if ( CreateFileW( path, fileaccess, fileshare, &SecurityAttributes,
        ...
        .if ( eax == ( GENERIC_READ or GENERIC_WRITE ) && ( edi & _O_WRONLY ) )
            ...
            .ifd ( CreateFileW( path, fileaccess, fileshare, &SecurityAttributes,
                    filecreate, fileattrib, NULL ) == -1 )
