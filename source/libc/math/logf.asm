...
include intrin.inc
undef __vdecl_logf4
alias <__vdecl_logf4>=<logf>
define g_XMInvLgE <{ +6.93147182e-1, +6.93147182e-1, +6.93147182e-1, +6.93147182e-1 }>
endif
...
logf proc uses xmm6 xmm7 x:float

  local exponentSub:XVECTOR
