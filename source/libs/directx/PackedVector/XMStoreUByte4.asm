...
XMStoreUByte4 proc XM_CALLCONV pDestination:ptr XMUBYTE4, V:FXMVECTOR
    ...
    _mm_min_ps(xmm1, { 255.0, 255.0, 255.0, 255.0 })

    ;; Scale by multiplication

    _mm_mul_ps(xmm1, { 1.0, 256.0*0.5, 256.0*256.0, 256.0*256.0*256.0*0.5 })
