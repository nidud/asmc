...
_defwinproc proc public hwnd:THWND, uiMsg:uint_t, wParam:WPARAM, lParam:LPARAM
    ...
    .case WM_ENTERIDLE
       ...
       .return(0)
    .case WM_SETFOCUS
       .return wm_setfocus(hwnd)
    .case WM_KILLFOCUS
       .return wm_killfocus(hwnd)
    .case WM_LBUTTONDOWN
       .return wm_lbbuttondown(hwnd, ecx)
    .case WM_LBUTTONUP
       .return wm_lbuttonup(hwnd)
    .case WM_MOUSEMOVE
       .return wm_mousemove(hwnd, ecx)
    .case WM_KEYDOWN
        mov eax,edx
       .return wm_keydown(hwnd, eax, ecx)
    .case WM_SYSCHAR
       .return wm_syschar(hwnd, edx)
    .case WM_CHAR
       .return wm_char(hwnd, edx)
    .endsw
    .return( 1 )
