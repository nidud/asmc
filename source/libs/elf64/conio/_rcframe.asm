...
_rcframe proc uses rbx _wz:TRECT, _rc:TRECT, _wp:PCHAR_INFO, _type:int_t, _attrib:uchar_t
   ...
   .new wz:TRECT = _wz
   .new rc:TRECT = _rc
   .new wp:PCHAR_INFO = _wp
   .new type:int_t  = _type
   .new attrib:uchar_t = _attrib
