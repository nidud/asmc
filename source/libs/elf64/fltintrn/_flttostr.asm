...
_flttostr proc uses rbx r12 r13 r14 r15 q:ptr, cvt:ptr FLTINFO, buf:string_t, flag:uint_t
  ...
  local endbuf :ptr
    ...
    .if ecx & _ST_LONGDOUBLE
        mov eax,LD_CVT_DIGITS
    .elseif ecx & _ST_QUADFLOAT
