...
_output proc public uses rbx r12 r13 r14 r15 _fp:LPFILE, format:string_t, arglist:ptr_t
        ...
        .if eax <= 7
            ...
            .switch eax
              ...
              .case ST_FLAG
                movzx   eax,dl
                .switch eax
                  .case '+': or r12d,FL_SIGN:      .endc ; '+' force sign indicator
                  .case ' ': or r12d,FL_SIGNSP:    .endc ; ' ' force sign or space
                  .case '#': or r12d,FL_ALTERNATE: .endc ; '#' alternate form
                  .case '-': or r12d,FL_LEFT:      .endc ; '-' left justify
                  .case '0': or r12d,FL_LEADZERO:  .endc ; '0' pad with leading zeros
                .endsw
                .endc
