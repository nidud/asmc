...
struct objbuff {
    unsigned char *curr;
    unsigned char *end;
    unsigned char *start_lidata;
    unsigned char *end_lidata;
    obj_format    objformat;
};

#define BORLAND_EXT       1 /* 1=accept BORLAND extensions */

extern list_of_names    *FindName( unsigned_16 );
extern unsigned_16      GetIdx( struct objbuff * );
extern void             SkipIdx( struct objbuff * );
