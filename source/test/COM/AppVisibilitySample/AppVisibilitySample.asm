...
.class CAppVisibilityNotificationSubscriber : public IAppVisibilityEvents
    ...
    CAppVisibilityNotificationSubscriber proc :ptr
   .ends
...
CAppVisibilityNotificationSubscriber::CAppVisibilityNotificationSubscriber proc v:ptr
    ...
    mov [rcx].lpVtbl,rdx
    mov [rcx].RefCount,0
    mov [rcx].cLauncherChanges,0

    assume rdx : ptr CAppVisibilityNotificationSubscriberVtbl

    mov [rdx].QueryInterface,                &CAppVisibilityNotificationSubscriber_QueryInterface
    mov [rdx].AddRef,                        &CAppVisibilityNotificationSubscriber_AddRef
    mov [rdx].Release,                       &CAppVisibilityNotificationSubscriber_Release
    mov [rdx].LauncherVisibilityChange,      &CAppVisibilityNotificationSubscriber_LauncherVisibilityChange
    mov [rdx].AppVisibilityOnMonitorChanged, &CAppVisibilityNotificationSubscriber_AppVisibilityOnMonitorChanged
...
_tmain proc
    ...
    .if ( SUCCEEDED(hr) )
        ...
        .if ( SUCCEEDED(hr) )
            ...
            ;
            .new v:CAppVisibilityNotificationSubscriberVtbl
            .new spSubscriber:CAppVisibilityNotificationSubscriber( &v )
            ;
