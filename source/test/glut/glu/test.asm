...
bSetupPixelFormat proc WINAPI hdc:HDC
...
resize proc WINAPI width:GLsizei, height:GLsizei
...
initializeGL proc WINAPI width:GLsizei, height:GLsizei
...
polarView proc WINAPI _radius:GLdouble, _twist:GLdouble, _latitude:GLdouble,
           _longitude:GLdouble
...
MainWndProc proc WINAPI hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
...
_tWinMain proc WINAPI hInstance:HINSTANCE, hPrevInstance:HINSTANCE, lpCmdLine:LPTSTR, nCmdShow:SINT
