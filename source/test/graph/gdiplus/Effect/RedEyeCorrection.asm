...
WndProc proc hWnd:HWND, message:UINT, wParam:WPARAM, lParam:LPARAM
  ...
  local ps:PAINTSTRUCT
    ...
    .case WM_PAINT
       ...
       .new P:RedEyeCorrectionParams
       .new B:RedEyeCorrection()
       .new a:Rect(0, 0, 100, 100)
...
_tWinMain proc hInstance:HINSTANCE, hPrevInstance:HINSTANCE, lpCmdLine:LPTSTR, nShowCmd:SINT
  ...
  local wc:WNDCLASSEX, msg:MSG, hwnd:HANDLE
    ...
    mov wc.lpszClassName,   &@CStr("RedEyeCorrection")
    mov wc.hCursor,         LoadCursor(0, IDC_ARROW)

    .ifd RegisterClassEx(&wc)

        .if CreateWindowEx(0, "RedEyeCorrection", "RedEyeCorrection", WS_OVERLAPPEDWINDOW,
