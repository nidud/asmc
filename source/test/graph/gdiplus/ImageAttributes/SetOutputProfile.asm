  ...
  local ps:PAINTSTRUCT
    ...
    .case WM_PAINT
       ...
       .new imAtt:ImageAttributes()
        ...
        imAtt.SetOutputChannelColorProfile(L"TEKPH600.ICM", ColorAdjustTypeBitmap)
...
_tWinMain proc hInstance:HINSTANCE, hPrevInstance:HINSTANCE, lpCmdLine:LPTSTR, nShowCmd:SINT
  ...
  local wc:WNDCLASSEX, msg:MSG, hwnd:HANDLE
    ...
    mov wc.lpszClassName,   &@CStr("SetOutputChannelColorProfile")
    mov wc.hCursor,         LoadCursor(0, IDC_ARROW)

    .ifd RegisterClassEx(&wc)

        .if CreateWindowEx(0, "SetOutputChannelColorProfile", "SetOutputChannelColorProfile", WS_OVERLAPPEDWINDOW,
