...
regress proc uses esi edi ebx
	...
	.if strcmp(arg_1, arg_1)
	    printf( "error 1: eax = %d (%d) strcmp\n", eax, 0 )
	    inc	   nerror
	.endif

	.if strcmp(addr str_1, addr str_2) != -1
	    printf( "error 2: eax = %d (%d) strcmp\n", eax, -1 )
	    inc	   nerror
	.endif
	.if strcmp(addr abc2, addr abc1)
	    printf( "error 3: eax = %d (%d) strcmp\n", eax, 0 )
	    inc	   nerror
	.endif
	.if strcmp(addr abcd, addr abc1) != 1
	    printf( "error 4: eax = %d (%d) strcmp\n", eax, 1 )
	    inc	   nerror
	.endif
	.if strcmp(addr abcd, addr abc1) !=1
	    printf( "error 5: eax = %d (%d) strcmp\n", eax, 1 )
	    inc	   nerror
	.endif
	.if strcmp(addr z5, addr z6) !=-1
	    printf( "error 6: eax = %d (%d) strcmp\n", eax, -1 )
	    inc	   nerror
	.endif
	.if strcmp(addr z6, addr z5) !=1
	    printf( "error 7: eax = %d (%d) strcmp\n", eax, 1 )
	    inc	   nerror
	.endif
