...
InitGeometry proc uses rdi rbx
   ...
   .new theta:FLOAT
    ...
    .if FAILED(D3DXCreateTextureFromFile( g_pd3dDevice, L"tiger.png", &g_pTexture ))
        MessageBox( NULL, L"Could not find tiger.png", L"Textures.exe", MB_OK )
       .return( E_FAIL )
    .endif
    .if FAILED(g_pd3dDevice.CreateVertexBuffer(50 * 2 * CUSTOMVERTEX, 0, D3DFVF_CUSTOMVERTEX, D3DPOOL_DEFAULT, &g_pVB, NULL))
        .return( E_FAIL )
    .endif
    .if FAILED(g_pVB._Lock(0, 0, &pVertices, 0))
        .return( E_FAIL )
    .endif
...
wWinMain proc hInst:HINSTANCE, hPrevInstance:HINSTANCE, lpCmdLine:LPWSTR, nShowCmd:SINT
   ...
   .new hWnd:HWND
    ...
    RegisterClassEx( &wc )
    mov hWnd,CreateWindowEx(0, L"D3D Tutorial", L"D3D Tutorial 05: Textures", WS_OVERLAPPEDWINDOW,
