...
InitVB proc
    .new pVertices:ptr
    .if FAILED(g_pd3dDevice.CreateVertexBuffer(3*CUSTOMVERTEX, 0, D3DFVF_CUSTOMVERTEX, D3DPOOL_DEFAULT, &g_pVB, NULL))
        .return( E_FAIL )
    .endif
    .if FAILED(g_pVB._Lock(0, sizeof(vertices), &pVertices, 0))
        .return( E_FAIL )
    .endif
...
wWinMain proc hInst:HINSTANCE, hPrevInstance:HINSTANCE, lpCmdLine:LPWSTR, nShowCmd:SINT
   ...
   .new hWnd:HWND
    ...
    RegisterClassEx( &wc )
    mov hWnd,CreateWindowEx(0, L"D3D Tutorial", L"D3D Tutorial 02: Vertices", WS_OVERLAPPEDWINDOW,
