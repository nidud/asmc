...
OnCommand proc hWnd:HWND, id:int_t, hwndCtl:HWND, codeNotify:UINT
    .if (id == IDC_SENDMSG_BUTTON)
        ...
        .if (hTargetWnd == NULL)
            MessageBox(hWnd, L"Unable to find the \"ReceiveWM_COPYDATA\" window", L"Error", MB_ICONERROR)
            .return
        .endif
        ...
        .if (!fTranslated)
            ...
            .return
        .endif
        GetDlgItemText(hWnd, IDC_MESSAGE_EDIT, &myStruct.Message, ARRAYSIZE(myStruct.Message))
