...
wmain proc uses rdi argc:int_t, argv:ptr ptr wchar_t, envp:ptr ptr wchar_t
  ...
  local SubmitResult:WER_SUBMIT_RESULT
    ...
    mov hr,E_FAIL
    xor eax,eax
    mov ReportHandle,rax
    lea rdi,ReportInformation
    mov ecx,sizeof(WER_REPORT_INFORMATION)
    rep stosb
