...
ifdef _UNICODE
        ...
        lea rdx,@CStr("SSE2")
        .switch
        .case eax & SSE_AVX512F: lea rdx,@CStr("AVX512") : .endc
        .case eax & SSE_AVX2:    lea rdx,@CStr("AVX2")   : .endc
        .case eax & SSE_AVX:     lea rdx,@CStr("AVX")    : .endc
        .case eax & SSE_SSE42:   lea rdx,@CStr("SSE4.2") : .endc
        .case eax & SSE_SSE41:   lea rdx,@CStr("SSE4.1") : .endc
        .case eax & SSE_SSSE3:   lea rdx,@CStr("SSSE3")  : .endc
        .case eax & SSE_SSE3:    lea rdx,@CStr("SSE3")   : .endc
        .endsw
        _tprintf( "%s)\n", rdx )
    .else
